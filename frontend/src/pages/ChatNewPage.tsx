      ...
      <div className="space-y-3">
        {workspaces.map((ws, i) => (
          <motion.button
            ...
            className="w-full text-left glass rounded-xl border border-glass-border p-5 transition-all duration-200 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(124,92,255,0.06)] group"
          >
