    ...
    >
      ...
      <div className="relative group">
        ...
        <input
          ...
          className="w-full glass-input rounded-xl pl-10 pr-10 py-3 text-sm text-text placeholder-text-dim transition-all focus:outline-none focus:border-primary/40 focus:shadow-[0_0_20px_rgba(99,102,241,0.08)]"
